const es = {
  ...
  flows: {
    title: 'Caudales',
    homeTitle: 'Ríos ahora',
    riverNow: 'Caudal ahora',
    seeAll: 'Ver todos',
    segMine: 'Mis ríos',
    segFlows: 'Caudales',
    loading: 'Cargando caudales…',
    error: 'No pudimos cargar los caudales. Desliza para reintentar.',
    empty: 'Sin estaciones disponibles',
    noData: 'Sin datos',
    sampleBanner: 'Datos de ejemplo — la conexión con la DGA está en desarrollo',
    ...
    detail: {
      current: 'Caudal actual',
      chart: 'Últimos 7 días',
      thresholds: 'Niveles de referencia',
      thresholdBajo: 'Bajo: menos de {{value}} m³/s',
      thresholdMedio: 'Medio: {{from}}–{{to}} m³/s',
      thresholdAlto: 'Alto: {{from}}–{{to}} m³/s',
      thresholdCrecida: 'Crecida: más de {{value}} m³/s',
      station: 'Estación',
      stationName: 'Nombre',
      code: 'Código BNA',
      region: 'Región',
      source: 'Fuente: red hidrométrica DGA (MOP)',
      empty: 'Sin lecturas en los últimos 7 días',
      min: 'Mín 7d',
      avg: 'Prom 7d',
      max: 'Máx 7d',
    },
